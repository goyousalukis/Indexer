...
cprequire_test(["inline:com-chilipeppr-indexer"], function(ws) {
    ...
    $('title').html("Lathe Indexer");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-indexer", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-indexer", // Make the id the same as the cpdefine id
        name: "Workspace / Sample", // The descriptive name of your widget.
        desc: `A Lathe Indexing Tool`,
        ...
        loadXYZWidget: function(callback) {
            ...
            $("body").append('<' + 'div id="com-chilipeppr-widget-xyz-instance"><' + '/div>');
